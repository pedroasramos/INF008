...
public class CustomerRepositoryImp implements CustomerRepository{
    ...
    public Customer findById(int customer_id) {
        String sql = "SELECT customer_id, name, email FROM customers WHERE customer_id = ?";
    ...
    public Customer findByEmail(String email) {
        String sql = "SELECT customer_id, name, email FROM customers WHERE email = ?";
    ...
    public void update(Customer customer) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            stmt.setString(1, customer.getName());
            stmt.setString(2, customer.getEmail());
            stmt.setInt(3, customer.getCustomer_id());
